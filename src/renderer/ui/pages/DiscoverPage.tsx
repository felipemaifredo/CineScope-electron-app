...
import { SeriesDetailModal } from "@/ui/components/SeriesDetailModal"
import { tmdb } from "@/Lib/utils/tmdb"

//Types
import { type TMDBSeries, type TMDBGenreTypes } from "@/Lib/utils/tmdb"
...
export const DiscoverPage = () => {
  ...
  const selectedGenreNames = genres
    .filter(function (g) { return selectedGenres.includes(g.id) })
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-4">
        <div className="flex-1 min-w-[200px]">
          <Button
            ...
            onClick={function () { setShowGenreModal(true) }}
          >
      ...
      {selectedGenreNames.length > 0 && (
        <div className="flex flex-wrap gap-2">
          {selectedGenreNames.map(function (name) {
            return (
              <span
                key={name}
        ...
        {loading ? (
          ...
          series.map(function (show) {
            return (
              <Card
                key={show.id}
                onClick={function () { handleCardClick(show.id) }}
                className="group overflow-hidden border-zinc-800 bg-zinc-900/40 hover:border-zinc-700 max-w-[280px] min-w-[280px] cursor-pointer transition-all hover:scale-[1.01]"
              >
      ...
      <Modal
        ...
        onClose={function () { setShowGenreModal(false) }}
      ...
      >
            ...
            return (
              ...
              >
                <input
                  ...
                  onChange={function () { toggleGenre(genre.id) }}
        ...
        <div className="flex gap-3 mt-6">
          ...
          <Button
            onClick={function () { setShowGenreModal(false) }}
            className="flex-1"
          >
            Apply
          </Button>
      ...
      <SeriesDetailModal
        ...
        onClose={function () { setIsDetailModalOpen(false) }}
